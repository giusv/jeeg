...
{-# LANGUAGE UndecidableInstances,MultiParamTypeClasses,FunctionalDependencies,FlexibleInstances,FlexibleContexts,ScopedTypeVariables #-}
{- 
...
hUnproxyLabel :: (HZip ls vs r,
                  HFind l ls n,
                  HUpdateAtHNat n v vs vs',
                  HZip ls vs' r')
              => l -> v -> Record r -> Record r'
