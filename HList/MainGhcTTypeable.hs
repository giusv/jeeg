...
{-
   ...
   This is a main module HList.for exercising a model with generic cast
   and TTypeable-based type equality. This module HList.is prepared for
   use with GHC. This model works, in principle, also for Hugs
   (see module HList.HugsTTypeable), but some details and some test
   cases require slight variations.

-}
module HList.MainGhcTTypeable where

import HList.Datatypes1
import HList.CommonMain
import HList.GhcSyntax
import HList.TypeEqBoolTTypeable
