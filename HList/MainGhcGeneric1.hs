...
{-
   ...
   This is a main module HList.for exercising a model with generic type
...
module HList.MainGhcGeneric1 (

 -- module HList.Datatypes2,
 module HList.CommonMain,
 module HList.GhcSyntax,
 module HList.GhcExperiments,
 module HList.TypeEqBoolGeneric,
 module HList.TypeEqGeneric1,
 module HList.TypeCastGeneric1,
 module HList.Label3

) where

-- import HList.Datatypes2
import HList.CommonMain hiding (HDeleteMany, hDeleteMany)
import HList.GhcSyntax
import HList.GhcExperiments
