...
> 
> module HList.KW where
> 
> import HList.FakePrelude hiding (TypeEq,typeEq,proxyEq,TypeCast,typeCast)
...
function. We thus infringe on the area of object and module HList.systems.
